...
public class SettingsManager {
    ...
    private int swipeActionRight = SwipeListView.SWIPE_ACTION_CHOICE;

    /**
     * 菜单显示方向（左边还是右边）
     */
    private int slidingMenuMode = SlidingMenu.LEFT;
    ...
    public int getSlidingMenuMode() {
        return slidingMenuMode;
    }

    public void setSlidingMenuMode(int slidingMenuMode) {
        this.slidingMenuMode = slidingMenuMode;
    }
